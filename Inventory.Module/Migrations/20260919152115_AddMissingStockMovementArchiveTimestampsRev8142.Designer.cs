...
namespace Inventory.Module.Migrations
{
    ...
    [Migration("20260919152115_AddMissingStockMovementArchiveTimestampsRev8142")]
    partial class AddMissingStockMovementArchiveTimestampsRev8142
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.StockMovementArchive", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("OriginalMovementId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("MovementDate")
                        .HasDatabaseName("IX_StockMovements_Archive_MovementDate");

                    b.HasIndex("OriginalMovementId")
                        .HasDatabaseName("IX_StockMovements_Archive_OriginalMovementId");

                    b.ToTable("StockMovements_Archive", (string)null);
                });
            ...
            modelBuilder.Entity("Core.Entities.StockReservation", b =>
                {
                    ...
                    b.HasIndex("ExpiryDate", "IsConfirmed")
