...
| Req.3 | Facturacion digital | Factura digital NO fiscal (recibo/nota de entrega) IMPLEMENTADA: PDF asincrono no bloqueante (8.50) + endpoint de descarga on-demand e integracion en la UI del cajero (modal de venta completada) (8.51) | Aprobado | F2 (base + implementacion) | IMPLEMENTADO (8.51); impresora termica futura |
