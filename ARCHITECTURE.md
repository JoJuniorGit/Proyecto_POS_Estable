...
2. **Defensas del Scraper y Observabilidad:**
   ...
   - Redondeo Hacia Arriba (Ceiling): Se aplica redondeo hacia arriba a 2 decimales (`PricingCalculator.RoundExchangeRateCeiling`: `Math.Ceiling(rate * 100) / 100`; ej. 804.63005 -> 804.64) antes de persistir y propagar (guía §2.4).
