...
- **OQ-1 (gates S3b-03..S3b-05) — ACCEPTED (dispatch, S3b)** — Maintainer accepted semantic rewrites of the 18 legacy tests, not a mechanical call swap. Fallback rejected: non-public adapter + `InternalsVisibleTo("CommandCenter.Tests")` (spec-forbidden as a public adapter).
